            ...
            <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform ${isOpen ? "translate-x-0" : "-translate-x-full"} bg-gray-100 border-r border-gray-300 sm:translate-x-0 shadow-lg`} aria-label="Sidebar">
                <div className="h-full px-4 pb-4 overflow-y-auto bg-gray-100 text-gray-900">
                    <ul className="space-y-4 font-medium">
                        ...
                        <li>
                            <Link to="/alljobs" className="flex items-center p-3 text-gray-900 hover:bg-gray-300 rounded-lg transition-colors duration-200">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                        ...
                        <li>
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 9.75a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375m-13.5 3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14 1.14 0 0 1 .778-.332 48.294 48.294 0 0 0 5.83-.498c1.585-.233 2.708-1.626 2.708-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z" />
                                ...
                                <span className="inline-flex items-center justify-center w-6 h-6 p-3 ml-3 text-sm font-medium text-gray-800 bg-gray-300 rounded-full">3</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div className="absolute bottom-4 left-0 w-full px-4">
                    <Link to="/landing" className="flex items-center p-3 text-white bg-red-500 hover:bg-red-600 rounded-lg transition-colors duration-200">
                        <svg className="flex-shrink-0 w-5 h-5 text-white transition duration-75" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
